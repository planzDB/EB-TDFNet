...
def parse_args():
    ...
    parser.add_argument("--input-img-dir", default="/root/autodl-tmp/Mass_512/train")
    parser.add_argument("--input-mask-dir", default="/root/autodl-tmp/Mass_512/train_labels")
    parser.add_argument("--output-img-dir", default="/root/autodl-tmp/Mass_512/train_images")
    parser.add_argument("--output-mask-dir", default="/root/autodl-tmp/Mass_512/train_masks")
